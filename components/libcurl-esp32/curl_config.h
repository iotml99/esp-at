...
/* Ensure HTTP support is enabled for ESP build */
...
/* ESP32: no POSIX sigaction, disable to avoid link error */
...
/* Enable mbedTLS as the TLS backend in ESP-IDF environment */
#ifndef USE_MBEDTLS
